...
public class MessageController {
	...
	public String write(@RequestParam("id") String id, UserVO vo, Model model) {
	...
	public String list(String id, UserVO vo, Model model, MessageVO cri)throws Exception {
	...
	public String recv(String id, UserVO vo, Model model, MessageVO cri)throws Exception {
